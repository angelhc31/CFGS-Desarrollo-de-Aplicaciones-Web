...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-07-2025 a las 19:04:49
...
--
-- Volcado de datos para la tabla `recolectas`
--

INSERT INTO `recolectas` (`id`, `recolector`, `perro`, `zona`, `peso`, `fecha`) VALUES
(29, 18, 6, 2, 2342, '2025-06-18'),
(30, 18, 5, 5, 2342, '2025-06-03');
...
(18, 'Eric', 'Perez Garcia', '12345678', 'angelhessecaracena@gmail.com', '681000250', 'ErPe0Z', '$2y$10$sDzVmHYVmTyPSdL2.NJZzO3h2qvM7kAWPjMHOwcYeIt0iOEja.dVa', 0, '');
...
(2, 'Zona B', 1000, '2025-06-18'),
(3, 'Zona C', 1050, '0000-00-00'),
(4, 'Zona D', 1050, '0000-00-00'),
(5, 'Zona E', 1050, '2025-06-03'),
